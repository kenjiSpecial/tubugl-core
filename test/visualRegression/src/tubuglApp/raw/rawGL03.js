...
export default class App {
    ...
    createProgram(){
        let vertexShader = webGLShader(this.gl, this.gl.VERTEX_SHADER, vertexShaderSrc.trim());
        let fragmentShader = webGLShader(this.gl, this.gl.FRAGMENT_SHADER, fragmentShaderSrc.trim());

        this._program = this.initProgram(vertexShader, fragmentShader);

        this.gl.useProgram(this._program);

        this._positionAttribLocation = this.gl.getAttribLocation(this._program, 'positoin');
        ...
        this.gl.bufferData(this.gl.ARRAY_BUFFER, new Float32Array([0.8, 0.0, 0.0, 1.0]), this.gl.DYNAMIC_COPY);
        ...
        this.gl.bufferData(this.gl.ARRAY_BUFFER, Float32Array.BYTES_PER_ELEMENT * 4, this.gl.DYNAMIC_COPY);
        ...
        this.gl.bindTransformFeedback(this.gl.TRANSFORM_FEEDBACK, this._transformFeedback);
    }
    ...
    initProgram(vertexShader, fragmentShader){
        ...
        this.gl.transformFeedbackVaryings( program, ["gl_Position"], this.gl.SEPARATE_ATTRIBS )
    ...
    update(){
        ...
        this.gl.bindBufferBase(this.gl.TRANSFORM_FEEDBACK_BUFFER, 0, this._outBuffer);
